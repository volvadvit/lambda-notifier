package com.epam.volvadvit.lambda.handler;
...
public class ImageProcessHandler implements RequestHandler<Map<String, Object>, APIGatewayProxyResponseEvent> {
  ...
  private static final String SQS_QUEUE_NAME = "cloudx-UploadsNotificationQueue";
  private static final String TOPIC_ARN = "arn:aws:sns:eu-central-1:642256046589:cloudx-UploadsNotificationTopic";
